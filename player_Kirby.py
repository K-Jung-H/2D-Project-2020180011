...
class Kirby:
    ...
    def __init__(self, Player = "p1"):
        ...
        self.fast_effect = load_wav('resource/sound/MK_fast_a.wav')
        self.charge_effect = load_wav('resource/sound/MK_charge_attack.wav')
        self.charging_effect = load_wav('resource/sound/MK_charging.wav')
    ...
    def get_bb(self):
        ...
        elif self.state_machine.cur_state == Normal_Attack or self.state_machine.cur_state == Speed_Attack:
            if self.dir == 1:
